...
截至 `4d797122`：离线 FakeSourceAdapter、协议模拟、注册与能力策略、网络关闭策略、凭据隔离及 Provider secret-flow 已有源码与测试证据；第二物理机复验和 Team03/H4 外部整改复核已完成。最新本地离线门禁为 `136/136`、`verify-k2=PASS`、`verify-team03=PASS`；该结果仍只覆盖离线范围。
