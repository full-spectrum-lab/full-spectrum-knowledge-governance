...
设计补充状态（2026-09-03）：B1、H1、H2、H3、H4 的文档契约已补充；H3 已有离线 Fake Adapter、契约测试和本机复验证据，B1 已完成离线持久化链路，H1/H2 第一阶段已有本机复验证据，其余代码实现、完整契约测试和外部复审仍未完成，清单整体保持 `OPEN`。
...
- [ ] 责任人/证据：`c84ab2e`（仅 Retrieval 映射第一步，未关闭）。
